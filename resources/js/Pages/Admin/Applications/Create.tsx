...
export default function Create({ users, programs }: any) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Create Application</h2>}>
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <form onSubmit={submit} className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 space-y-6">
                        ...
                        <div className="flex justify-end pt-4">
                            <PrimaryButton disabled={processing}>Create Application</PrimaryButton>
                        </div>
                    </form>
                </div>
            </div>
